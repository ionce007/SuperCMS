          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <div class="bg-fff pd-20 radius-6 mb-10">
              ...
              <p class="f-15 c-4e5969 mb-16">
                SuperCMS基于Node、Express、MySQL、Vue3研发的高质量实用型CMS系统。轻量、灵活、易用、安全。
              </p>
      ...
      <el-col :xs="24" :sm="6" :md="6" :lg="6" :xl="6">
        <div class="bg-fff pd-20 radius-6 mb-10">
          ...
          <p class="f-13 mb-6"><span>官网地址：</span>
            <a href="//cms.foryet.com" target="blank">cms.foryet.com</a>
          </p>
          <p class="f-13 mb-6"><span>程序版本：</span>SuperCMS v{{ data.version }}</p>
          ...
          <p class="f-13 mb-6"><span>技术开发：</span>铜豌豆</p>
          <p class="f-13 mb-6 row"><span>联系微信：</span>-ionce</p>
          <p class="f-13 mb-6 row"><span>联系邮箱：</span>441619806@qq.com</p>
